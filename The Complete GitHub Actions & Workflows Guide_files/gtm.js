  ...
  var data = {
    resource: {
      ...
      tags: [
        ...
        },
        {
          ...
          vtp_fieldsToSet: [
            ...
            ["map", "fieldName", "title", "value", ["macro", 8]]
          ],
          vtp_useHashAutoLink: false,
          vtp_trackType: "TRACK_PAGEVIEW",
          vtp_decorateFormsAutoLink: false,
        ...
        },
        {
          ...
          vtp_fieldsToSet: [
            "list",
            ["map", "fieldName", "page", "value", "/CLP/Enroll"],
            ["map", "fieldName", "title", "value", "Enrollment Virtual Page"]
          ],
          vtp_useHashAutoLink: false,
          vtp_trackType: "TRACK_PAGEVIEW",
          vtp_decorateFormsAutoLink: false,
        ...
        },
        {
          ...
          vtp_fieldsToSet: [
            "list",
            ["map", "fieldName", "page", "value", "/landing/choose-topics"],
            ["map", "fieldName", "title", "value", "Choose Topics"]
          ],
          vtp_useHashAutoLink: false,
          vtp_trackType: "TRACK_PAGEVIEW",
          vtp_decorateFormsAutoLink: false,
        ...
        },
        {
          ...
          vtp_fieldsToSet: [
            "list",
            ["map", "fieldName", "page", "value", "/landing/search"],
            ["map", "fieldName", "title", "value", "Search on Landing Page"]
          ],
          vtp_useHashAutoLink: false,
          vtp_trackType: "TRACK_PAGEVIEW",
          vtp_decorateFormsAutoLink: false,
        ...
        },
        {
          ...
          vtp_fieldsToSet: [
            "list",
            ["map", "fieldName", "page", "value", "/landing/browse-menu-item"],
            ["map", "fieldName", "title", "value", "Browse Menu Item"]
          ],
          vtp_useHashAutoLink: false,
          vtp_trackType: "TRACK_PAGEVIEW",
          vtp_decorateFormsAutoLink: false,
      ...
      predicates: [
        ...
        { function: "_cn", arg0: ["macro", 5], arg1: "course-cta" },
        { function: "_cn", arg0: ["macro", 9], arg1: "paulatest" },
        { function: "_cn", arg0: ["macro", 10], arg1: "Choose Topics" },
        { function: "_cn", arg0: ["macro", 9], arg1: "organization/landing/" },
        { function: "_cn", arg0: ["macro", 5], arg1: "search" },
        { function: "_cn", arg0: ["macro", 5], arg1: "js-searchbox-input" },
        { function: "_cn", arg0: ["macro", 7], arg1: "/browse/list/" },
        { function: "_cn", arg0: ["macro", 9], arg1: "/organization/landing/" },
        { function: "_ew", arg0: ["macro", 9], arg1: "portal-not-ready/" },
        { function: "_cn", arg0: ["macro", 9], arg1: "citigroup" }
      ],
      rules: [
        [
          ["if", 0],
...
*/
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    H = function (a, b) {
      ...
      for (d in a)
        if (Ub(a, d)) {
          var e = a[d];
          "array" == Tb(e)
            ? ("array" != Tb(c[d]) && (c[d] = []), (c[d] = H(e, c[d])))
            : Vb(e)
            ? (Vb(c[d]) || (c[d] = {}), (c[d] = H(e, c[d])))
            : (c[d] = e);
        }
      return c;
    };
    ...
    Ic = function (a, b) {
      ...
      for (g in a)
        if (a.hasOwnProperty(g))
          if (0 === g.indexOf("vtp_"))
            e && d && d.$f && d.$f(a[g]), (f[void 0 !== e ? g : g.substr(4)] = a[g]);
  ...
  O.ad = "c10";
  O.U = "dataLayer";
  O.Wg = "ChEIgMPajgYQobfMvonE27PaARIjAAs+ocMBN5zWYKd8YIHanUS+QCRo1g5QaP8FyG04T3yGaHUaAnVP";
  var Gd = {
      __cl: !0,
      __ecl: !0,
      __ehl: !0,
  ...
  var Kd = Jd,
    ...
    Md = null,
    Nd = null,
    Od = "https://www.googletagmanager.com/a?id=" + O.J + "&cv=61",
    Pd = {},
    Qd = {},
    Rd = function () {
      var a = R.sequence || 1;
  ...
  var Ze = [N.C, N.H],
    $e = function (a) {
      ...
      var c = a[N.We];
      c && Ed(41);
      for (var d = va(b) ? b : [b], e = { Ub: 0 }; e.Ub < d.length; e = { Ub: e.Ub }, ++e.Ub)
        Aa(
          a,
          (function (f) {
            return function (g, l) {
  ...
  var Qf = function (a) {
    ...
    Tf = function (a) {
      ...
      for (c in a.eventModel)
        c !== N.Mb && a.eventModel.hasOwnProperty(c) && void 0 !== a.eventModel[c] && b.push(c);
      return b;
    };
  var Uf,
    Vf = !1,
  ...
  function Rg(a, b, c) {
    for (var d = [], e = Qg(a, void 0, void 0, c), f = 0; f < e.length; f++) {
      ...
      if (!b || -1 !== b.indexOf(l)) {
        var k = g.shift();
        k &&
          ((k = k.split("-")), d.push({ id: g.join("."), jd: 1 * k[0] || 1, yc: 1 * k[1] || 1 }));
      }
    }
    return d;
  }
  ...
  function lh(a, b, c) {
    ...
    var e = d.split(".");
    5 === e.length
      ? ((ih[a] = e.slice(0, 2).join(".")),
        (jh[a] = { id: e.slice(2, 4).join("."), ng: Number(e[4]) || 0 }))
      : 3 === e.length
      ? (jh[a] = { id: e.slice(0, 2).join("."), ng: Number(e[2]) || 0 })
      : (ih[a] = d);
    return !0;
  }
  function kh(a) {
  ...
  function Sh(a, b) {
    ...
    var c = [
      ...
      Ob(),
      Math.floor(Pa() / 60 / 1e3) - (void 0 === b ? 0 : b),
      tb.userAgentData.brands,
      tb.userAgentData.mobile,
      tb.userAgentData.platform,
      a
    ].join("*");
    return xh(c).toString(36);
  }
    ...
    li = function (a) {
      ...
      for (var d = {}, e = 0; e < c.length; d = { Fc: d.Fc }, e++) {
        ...
        if (null != f) {
          ...
          p
            ? ((p.timestamp = Math.max(p.timestamp, k)), (p.labels = oi(p.labels, n || [])))
            : b.push({ version: l, qa: d.Fc, timestamp: k, labels: n });
        }
      }
      b.sort(function (r, v) {
  ...
  function ti(a, b, c, d, e) {
    ...
    a.gp && f("gp", p(a.gp[0]));
    if (
      (void 0 == fi.enable_gbraid_cookie_write ? 0 : fi.enable_gbraid_cookie_write) &&
      !k &&
      a.gb
    ) {
      var r = a.gb[0],
      ...
      if (!b)
        for (var q = li(v), u = 0; u < q.length; u++)
          q[u].qa === r && q[u].labels && 0 < q[u].labels.length && (t = !0);
      t || f("gb", p(r));
    }
  }
  var xi = function (a, b) {
    ...
    wi = function (a) {
      return 0 !== yi(a.split(".")).length ? 1e3 * (Number(a.split(".")[1]) || 0) : 0;
    };
  function ni(a) {
    var b = yi(a.split("."));
    return 0 === b.length
      ? null
      : { version: b[0], qa: b[2], timestamp: 1e3 * (Number(b[1]) || 0), labels: b.slice(3) };
  }
  function yi(a) {
    return 3 > a.length || ("GCL" !== a[0] && "1" !== a[0]) || !/^\d+$/.test(a[1]) || !hi.test(a[2])
      ? []
      : a;
  }
  ...
  var tj = function (a) {
      ...
      if (m[b]) m.hasOwnProperty(b) || Ed(12);
      else {
        var c = function () {
          c.q = c.q || [];
          c.q.push(arguments);
  ...
  var Hj = function (a) {},
    ...
    Oj = function () {
      ...
      void 0 === Tj ||
        ...
        (Xj[Tj] || Yj.Fi() || 0 >= Zj--
          ? (Ed(1), (Xj[Tj] = !0))
          : (Yj.$i(), Eb(Nj(!0)), (Uj[Tj] = !0), (ak = bk = ck = Wj = Vj = "")));
    },
    Nj = function (a) {
      var b = Tj;
      if (void 0 === b) return "";
  ...
  function Bk(a, b, c, d) {
    ...
    if (g && g.length) {
      ...
      f = Bk(
        l.index,
        { onSuccess: f, onFailure: 1 === l.fg ? b.terminate : f, terminate: b.terminate },
        c,
        d
      );
    }
  ...
  function Ck(a, b, c, d) {
    ...
    if (n && n.length) {
      var p = n[0],
        r = Bk(p.index, { onSuccess: g, onFailure: l, terminate: k }, c, d);
      if (!r) return null;
      g = r;
      l = 2 === p.fg ? k : r;
    }
    if (f[Xb.Jf] || f[Xb.Oh]) {
      var v = f[Xb.Jf] ? Dc : c.jj,
        t = g,
        q = l;
      if (!v[a]) {
        e = Ra(e);
      ...
      if (0 === l)
        if (a.purpose && a.vendor) {
          ...
          k =
            ...
            ((ze(we) ? 0 : "DE" === a.publisherCC) || "CH" === a.publisherCC)
              ? !0
  ...
  var tl = function (a, b) {
    ...
    Bl = function () {
      var a = sl(),
        ...
        c = new tl(b, a);
      if (
        (wl() ? !0 === m.gtag_enable_tcf_support : !1 !== m.gtag_enable_tcf_support) &&
        !a.active &&
        ("function" === typeof m.__tcfapi || jl(b))
      ) {
        a.active = !0;
        a.Ac = {};
        xl();
                ...
                for (l in pl)
                  if (pl.hasOwnProperty(l))
                    if ("1" === l) {
                      ...
                      !1 === v.gdprApplies
                        ? (r = !0)
                        : (void 0 === v.internalErrorState && (v.internalErrorState = gl(v)),
                          (r =
                            "error" === v.cmpStatus ||
  ...
  var am = function (a, b, c) {
    ...
    hm = function (a, b, c, d) {
      ...
      if (b && c) {
        d = d || {};
        for (
          var e = { countryNameCode: c, destinationNumber: b, retrievalTime: Oa() }, f = 0;
          f < a.length;
          f++
        ) {
          var g = a[f];
          fm[g.id] ||
            (g && "AW" === g.prefix && !e.adData && 2 <= g.M.length
              ? ((e.adData = { ak: g.M[0], cl: g.M[1] }), (fm[g.id] = !0))
              : g &&
                "UA" === g.prefix &&
                !e.gaData &&
                ((e.gaData = { gaWpid: g.containerId }), (fm[g.id] = !0)));
        }
              ...
              for (var x = 0; x < n.length; x++)
                if (x < u)
                  if (d) hm(d, n[x], t, { Ma: q, options: v });
                    ...
                    im()
                      ? hm([a], n[x], t || "US", { Ma: q, options: v })
                      : gm(a.M[0], a.M[1], n[x], { Ma: q, options: v });
                  else if ("UA" === a.prefix)
  ...
  var rn = function (a, b) {},
            ...
            if (c.isGtmEvent || vn(b, k.createOnlyFields)) {
              ...
              d &&
                ...
                l(function () {
                  ...
                  !t ||
                    (t.get("clientId") == n && p) ||
                    (c.isGtmEvent ? (k.fieldsToSet["&gcu"] = "1") : (k.fieldsToSend["&gcu"] = "1"),
                    t.set(k.fieldsToSet),
                    c.isGtmEvent ? t.send("pageview") : t.send("pageview", k.fieldsToSend));
                }));
              c.isGtmEvent &&
                l(function () {
                  l.remove(f);
    ...
    Gn = function (a, b, c) {
      ...
      if (sa(l)) {
        ...
        var p = function (J) {
          ...
          r = function (J) {
            ...
            if (L) {
              ...
              "promo_view" !== T &&
                "impressions" !== T &&
                (I("ec:addProduct", L.wb), p("ec:setAction", T, L.Ya));
            }
          },
          v = function (J) {
            if (J) {
        ...
        !c.isGtmEvent &&
          vn(n, q.createOnlyFields) &&
          (l(function () {
            k() && k().remove(n);
          }),
          (Dn[n] = !1));
        l("create", f, q.createOnlyFields);
        if (q.createOnlyFields[N.jb] && !c.isGtmEvent) {
        ...
        if (b === N.Xb)
          ...
          b === N.wa
            ? (t(),
              jm(f, c),
              c.getWithConfig(N.Xa) && (Ci(["aw", "dc"]), xj(n + ".")),
              0 != q.sendPageView && p("send", "pageview", q.fieldsToSend),
              wn(f, n, c),
              !c.isGtmEvent && 0 < Tf(c).length && (Ed(68), 1 < R.configCount && Ed(69)))
            : b === N.Ga
            ? rn(n, c)
            : "screen_view" === b
            ? p("send", "screenview", q.fieldsToSend)
            : "timing_complete" === b
            ? ((q.fieldsToSend.hitType = "timing"),
              u("timingCategory", q.eventCategory, !0),
              c.isGtmEvent ? u("timingVar", q.timingVar, !0) : u("timingVar", q.name, !0),
              u("timingValue", Fa(q.value)),
              void 0 !== q.eventLabel && u("timingLabel", q.eventLabel, !0),
              p("send", q.fieldsToSend))
            : "exception" === b
            ? p("send", "exception", q.fieldsToSend)
            : "optimize.callback" === b ||
              ("" === b && c.isGtmEvent) ||
              ("track_social" === b && c.isGtmEvent
                ? ((q.fieldsToSend.hitType = "social"),
                  u("socialNetwork", q.socialNetwork, !0),
                  u("socialAction", q.socialAction, !0),
                  u("socialTarget", q.socialTarget, !0))
                : ((c.isGtmEvent || En[b]) && r(A),
                  c.isGtmEvent && e(),
                  ...
                  void 0 !== q.value && u("eventValue", Fa(q.value))),
              p("send", q.fieldsToSend));
        var E = !1;
        var D = Fn;
      ...
      function c(f) {
        ...
        function l() {
          if (f.category) k.category = f.category;
            ...
            for (var p = "", r = 0; r < In.length; r++)
              void 0 !== f[In[r]] && (p && (p += "/"), (p += f[In[r]]));
            p && (k.category = p);
          }
        }
        var k = H(f),
  ...
  var Fn,
    ...
    Mn = {},
    on = Object.freeze(
      ((Mn.client_storage = "storage"),
      (Mn.sample_rate = 1),
      (Mn.site_speed_sample_rate = 1),
      (Mn.store_gac = 1),
      (Mn.use_amp_client_id = 1),
      (Mn[N.hb] = 1),
      (Mn[N.la] = "storeGac"),
      (Mn[N.fa] = 1),
      (Mn[N.ma] = 1),
    ...
    On = Object.freeze(
      ...
      (Nn.cookiePath = 1),
      (Nn.cookieUpdate = 1),
      (Nn.legacyCookieDomain = 1),
      (Nn.legacyHistoryImport = 1),
      (Nn.name = 1),
      (Nn.sampleRate = 1),
      (Nn.siteSpeedSampleRate = 1),
      (Nn.storage = 1),
      (Nn.storeGac = 1),
      (Nn.useAmpClientId = 1),
      (Nn._cd2l = 1),
    ...
    pn = Object.freeze(
      ...
      (Qn.app_id = 1),
      (Qn.app_installer_id = 1),
      (Qn.app_name = 1),
      (Qn.app_version = 1),
      (Qn.description = "exDescription"),
      (Qn.fatal = "exFatal"),
      (Qn.language = 1),
      (Qn.page_hostname = "hostname"),
      (Qn.transport_type = "transport"),
      (Qn[N.ca] = "currencyCode"),
      (Qn[N.wf] = 1),
      (Qn[N.mb] = "location"),
      (Qn[N.Vd] = "page"),
      (Qn[N.Ia] = "referrer"),
    ...
    Cn = function (a, b, c, d) {
      if (void 0 !== c)
        if ((Wn[b] && (c = Ga(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a))
          d[qn(b)] = c;
        else if (ta(a)) d[a] = c;
    ...
    Xn = {},
    En = Object.freeze(
      ((Xn.checkout_progress = 1),
      (Xn.select_content = 1),
      (Xn.set_checkout_option = 1),
      (Xn[N.Cb] = 1),
      (Xn[N.Db] = 1),
      (Xn[N.eb] = 1),
      (Xn[N.Sa] = 1),
    ...
    co = {},
    eo = Object.freeze(
      ((co.view_search_results = 1), (co[N.Sa] = 1), (co[N.fb] = 1), (co[N.va] = 1), co)
    ),
    yn = function (a, b, c) {
    ...
    un = function (a, b, c) {
      ...
      if (c.isGtmEvent) {
        ...
        "login" === b || "sign_up" === b || "share" === b
          ? yn(f, "eventLabel", e(N.vf))
          : "search" === b || "view_search_results" === b
          ? yn(f, "eventLabel", e(N.zh))
          : "select_content" === b && yn(f, "eventLabel", e(N.oh));
        var D = f[N.ia] || {},
          F = D[N.Jb];
      ...
      Ke() &&
        ((l["&gcs"] = df()),
        cf(N.H) || (k.storage = "none"),
        cf(N.C) || ((l.allowAdFeatures = !1), (k.storeGac = !1)));
      var P = e(N.oa) || e(N.jb),
        J = e(N.Oc);
    ...
    An = function (a, b) {
      ...
      var r = null,
        v = d(N.th);
      a === N.sa || a === N.Eb
        ? (r = { action: a, Ya: c(), wb: Jn(e) })
        : a === N.Cb
        ? (r = { action: "add", wb: Jn(e) })
        : a === N.Db
        ? (r = { action: "remove", wb: Jn(e) })
        : a === N.va
        ? (r = { action: "detail", Ya: c(f), wb: Jn(e) })
        : a === N.Sa
        ? (r = { action: "impressions", mg: Jn(e) })
        : "view_promotion" === a
        ? (r = { action: "promo_view", zc: Jn(v) })
        : "select_content" === a && v && 0 < v.length
        ? (r = { action: "promo_click", zc: Jn(v) })
        : "select_content" === a
        ? (r = { action: "click", Ya: { list: d(N.Md) || f }, wb: Jn(e) })
        : a === N.eb || "checkout_progress" === a
        ? (r = {
            action: "checkout",
            wb: Jn(e),
        ...
        : "set_checkout_option" === a &&
          (r = { action: "checkout_option", Ya: { step: d(N.qf), option: d(N.pf) } });
      r && (r.ue = d(N.ca));
      return r;
    },
    go = {},
  ...
  var ko = function (a, b, c) {
    ...
    ro = function (a, b) {
      var c = Vl(b);
      return (a.o[c.containerId] = a.o[c.containerId] || new po());
    },
    so = function (a, b, c) {
      if (b) {
        var d = Vl(b);
        if (d && 1 === ro(a, b).status) {
          ...
          if (Vk()) {
            ...
            var g = "/gtag/js?id=" + encodeURIComponent(d.containerId) + "&l=" + O.U + "&cx=c";
            Uk() && (g += "&sign=" + O.bd);
            var l =
        ...
        if (f) {
          var g = H(c),
            ...
            q = Of(
              Nf(
                Pf(
                  Mf(Kf(Lf(Jf(If(Hf(g), l), k), n), p), function () {
                    zk(r, v, "2");
                    ho && t();
                  }),
                  function () {
  ...
  jo.prototype.insert = function (a, b, c) {
    ...
    0 < this.m.length
      ? this.m.splice(1, 0, new qo(a, d, c, b, !1))
      : this.m.push(new qo(a, d, c, b, !1));
  };
  ...
  function Fo(a, b) {
    ...
    b &&
      ((c.eventModel = H(b)),
      b[N.Hb] && (c.eventCallback = b[N.Hb]),
      b[N.Nc] && (c.eventTimeout = b[N.Nc]));
    return c;
  }
  function Go(a) {
  ...
  var Io = {
      ...
      set: function (a) {
        ...
        2 == a.length && Vb(a[1])
          ...
          : 3 == a.length &&
            ta(a[1]) &&
            ((b = {}), Vb(a[2]) || va(a[2]) ? (b[a[1]] = H(a[2])) : (b[a[1]] = a[2]));
        if (b) {
          b._clear = !0;
          return b;
        }
  ...
  var Up = m.clearTimeout,
    ...
    hq = function (a) {
      ...
      Uk() &&
        ((c += "&sign=" + O.bd), ub && (b = ub.replace(/^(?:https?:\/\/)?/i, "").split(/[?#]/)[0]));
      ...
      (function (a) {
        ...
        return b
          ? a.vtp_component && "URL" != a.vtp_component
            ? jg(lg(String(b)), a.vtp_component, a.vtp_stripWww, a.vtp_defaultPages, a.vtp_queryKey)
            : Zp(String(b))
          : String(b);
      });
    })();
  ...
  (Z.g.ua = ["google"]),
    (function () {
            ...
            y = function () {
              ...
              w &&
                ...
                z(function () {
                  ...
                  !J ||
                    (J.get("clientId") === F && P) ||
                    ((E["&gcs"] = df()), (E["&gcu"] = "1"), J.set(E), J.send("pageview"));
                }));
              z(function () {
                z.remove(C);
              });
      ...
      var p = function (q, u, x) {
          ...
          if (q)
            for (var w in q)
              if (!k[w] && q.hasOwnProperty(w) && ((x && g[w]) || (!x && void 0 === g[w]))) {
                var y = l[w] ? Ga(q[w]) : q[w];
        ...
        r = function (q) {
          var u = {};
          q.vtp_gaSettings && H(Pq(q.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), u);
          H(Pq(q.vtp_fieldsToSet, "fieldName", "value"), u);
          Ga(u.urlPassthrough) && (u._useUp = !0);
          q.vtp_transportUrl && (u._x_19 = q.vtp_transportUrl);
          if (!c) {
            u._x_19 && (u._cd2l = !0);
            cf(N.H) || (u.storage = "none");
            cf(N.C) || ((u.allowAdFeatures = !1), (u.storeGac = !1));
            nn() || (u.allowAdFeatures = !1);
            mn() || (u.allowAdPersonalizationSignals = !1);
            if (Ga(u.urlPassthrough)) {
              var x = !1;
              Ke() && !x && (u._cs = a);
            }
          }
        ...
        t = function (q) {
          function u(ja, ea) {
            void 0 !== q[ea] && M("set", ja, q[ea]);
          }
          function x() {
            if (q.vtp_doubleClick || "DISPLAY_FEATURES" == q.vtp_advertisingFeaturesType) {
              var ja = "_dc_gtm_" + String(q.vtp_trackingId).replace(/[^A-Za-z0-9-]/g, "");
              M("require", "displayfeatures", void 0, { cookieName: ja });
            }
          }
          var A = {},
            w = {},
          ...
          if (q.vtp_gaSettings) {
            ...
            H(Pq(C.vtp_contentGroup, "index", "group"), w);
            H(Pq(C.vtp_dimension, "index", "dimension"), y);
            H(Pq(C.vtp_metric, "index", "metric"), z);
            var E = H(C);
          ...
          H(Pq(q.vtp_contentGroup, "index", "group"), w);
          H(Pq(q.vtp_dimension, "index", "dimension"), y);
          H(Pq(q.vtp_metric, "index", "metric"), z);
          var D = r(q),
            F = "",
            P = tj(q.vtp_functionName);
          if (sa(P)) {
            var J = "",
              I = "";
            q.vtp_setTrackerName && "string" == typeof q.vtp_trackerName
              ? "" !== q.vtp_trackerName && ((I = q.vtp_trackerName), (J = I + "."))
              : ((I = "gtm" + Rd()), (J = I + "."));
            var M = function (ja) {
              ...
              L = function (ja, ea) {
                return void 0 === ea ? ea : ja(ea);
              },
              K = function (ja, ea) {
                if (ea)
                  for (var Na in ea)
                    ea.hasOwnProperty(Na) &&
                      (c ? (D[ja + Na] = ea[Na]) : M("set", ja + Na, ea[Na]));
              },
              T = function () {},
              V = function (ja, ea) {
                return void 0 === q[ja] ? A[ea] : q[ja];
              },
              S = String(q.vtp_trackingId || A.trackingId || "");
            if (c) {
              var qa = function () {
                if (q.vtp_doubleClick || "DISPLAY_FEATURES" == q.vtp_advertisingFeaturesType)
                  D.displayfeatures = !0;
              ...
              K("metric", z);
              var ra = {};
              q.vtp_enableEcommerce && (D.gtmEcommerceData = T());
              if ("TRACK_EVENT" === q.vtp_trackType)
                (F = "track_event"),
                  qa(),
                  (D.eventCategory = String(V("vtp_eventCategory", "category"))),
                  (D.eventAction = String(V("vtp_eventAction", "action"))),
                  (D.eventLabel = L(String, V("vtp_eventLabel", "label"))),
                  (D.value = L(Fa, V("vtp_eventValue", "value")));
              else if ("TRACK_PAGEVIEW" == q.vtp_trackType) {
                if (
                  ((F = N.Xb),
                  qa(),
                  "DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == q.vtp_advertisingFeaturesType &&
                    (D.remarketingLists = !0),
                  q.vtp_autoLinkDomains)
                ) {
                  var na = {};
                  na[N.N] = q.vtp_autoLinkDomains;
                  na.use_anchor = q.vtp_useHashAutoLink;
                  na[N.lb] = q.vtp_decorateFormsAutoLink;
                  D[N.ia] = na;
                }
              } else
                "TRACK_SOCIAL" === q.vtp_trackType
                  ...
                  : "TRACK_TIMING" == q.vtp_trackType &&
                    ((F = "timing_complete"),
                    (D.eventCategory = String(V("vtp_timingCategory", "category"))),
                    (D.timingVar = String(V("vtp_timingVar", "name"))),
                    (D.value = Fa(V("vtp_timingValue", "value"))),
                    (D.eventLabel = L(String, V("vtp_timingLabel", "label"))));
              q.vtp_enableRecaptcha && (D.enableRecaptcha = !0);
              q.vtp_enableLinkId && (D.enableLinkId = !0);
              n(D, ra);
              D.name || (ra.gtmTrackerName = I);
              ra.gaFunctionName = q.vtp_functionName;
              void 0 !== q.vtp_nonInteraction && (ra.nonInteraction = q.vtp_nonInteraction);
              var Ba = Pf(Mf(Hf(ra), q.vtp_gtmOnSuccess), q.vtp_gtmOnFailure);
              Ba.isGtmEvent = !0;
              Hn(S, F, Date.now(), Ba);
            }
            if (!c) {
              var W = function (ja, ea) {
                  void 0 !== ea && M("set", ja, ea);
                },
                oa = { name: I };
              p(D, oa, !0);
              P("create", S, oa);
              ...
              K("metric", z);
              var Ia = !1;
              Ke() && !Ia && (M("set", "&gcs", df()), b(S, q, I));
              D._x_19 && D._x_20 && !e[I] && ((e[I] = !0), P(Aj(I, String(D._x_20))));
              ...
              if (q.vtp_enableLinkId) {
                var Xa = {};
                M("require", "linkid", "linkid.js", Xa);
              }
              M("set", "hitCallback", function () {
                var ja = D && D.hitCallback;
                sa(ja) && ja();
                q.vtp_gtmOnSuccess();
              });
            }
            ...
            if ("TRACK_EVENT" == q.vtp_trackType) {
              if (!c) {
                if (q.vtp_enableEcommerce) {
                  var Sc = {};
                  Uk() && D._x_19 && (Sc._x_19 = D._x_19);
                  M("require", "ec", "ec.js", Sc);
                  T();
                }
                x();
                var qd = {
                  ...
                  eventLabel: L(String, V("vtp_eventLabel", "label")),
                  eventValue: L(Fa, V("vtp_eventValue", "value"))
                };
                p(Ea, qd, !1);
                M("send", qd);
              }
              ...
              if (q.vtp_enableEcommerce) {
                var Te = {};
                Uk() && D._x_19 && (Te._x_19 = D._x_19);
                M("require", "ec", "ec.js", Te);
                T();
              }
              x();
              if ("DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == q.vtp_advertisingFeaturesType) {
                ...
                M("require", "adfeatures", { cookieName: ud });
              }
              Ea ? M("send", "pageview", Ea) : M("send", "pageview");
              v(q, J);
              Ga(D.urlPassthrough) && xj(J);
            }
            if (!d) {
              var Qb = q.vtp_useDebugVersion ? "u/analytics_debug.js" : "analytics.js";
              q.vtp_useInternalVersion && !q.vtp_useDebugVersion && (Qb = "internal/" + Qb);
              d = !0;
              var Ue = Sk(D._x_19, "/analytics.js"),
                Ig = Zl("https:", "http:", "//www.google-analytics.com/" + Qb, D && !!D.forceSSL);
              U(
                "analytics.js" === Qb && Ue ? Ue : Ig,
                function () {
                  var ja = rj();
                  (ja && ja.loaded) || q.vtp_gtmOnFailure();
                },
                q.vtp_gtmOnFailure
              );
            }
    ...
    (function () {
      ...
      function l(t) {
        if ("form" === t.tagName.toLowerCase() && t.elements) {
          for (var q = 0, u = 0; u < t.elements.length; u++) Dp(t.elements[u]) && q++;
          return q;
        }
      }
      function k(t, q, u, x) {
      ...
      var c = function (d) {
        if (B.body) {
          var e = d.vtp_gtmOnFailure,
            ...
            l = f.onSuccess;
          if (d.vtp_useIframe) {
          } else d.vtp_supportDocumentWrite ? b(g, l, e) : a(B.body, Jb(g), l, e)();
        } else
          Vp(function () {
            c(d);
          }, 200);
  ...
  (Jt.macro = function (a) {
    ...
    (Jt.onHtmlSuccess = tp.bg(!0)),
    (Jt.onHtmlFailure = tp.bg(!1));
  Jt.dataLayer = de;
  ...
  function Lt() {
    ...
    if (b) {
      ...
      for (var t = g.rules || [], q = 0; q < t.length; q++) {
        for (var u = t[q], x = {}, A = 0; A < u.length; A++)
          x[u[A][0]] = Array.prototype.slice.call(u[A], 1);
        Ac.push(x);
      }
      Ec = Z;
      Fc = Kq;
  ...
  (function (a) {
    ...
    var f = function (r) {
        ...
        var u = {
          ...
          data: { scriptSource: ub, containerProduct: v, debug: !1, id: O.J }
        };
