  ...
  var A = /:[0-9]+$/,
    ...
    E = function (a, b) {
      ...
      "port" === b
        ...
        : "host" === b &&
          (a.hostname = (a.hostname || t.location.hostname).replace(A, "").toLowerCase());
...
*/
      ...
      if (a) {
        ...
        c
          ? ((e = d = ""),
            ...
            f.test(a) &&
              M.write(ff.createHTML("<script" + d + e + ' src="' + a + '">\x3c/script>')))
  ...
  function Pa(a) {
    try {
      O.navigator.sendBeacon
        ? J(42)
        : O.XMLHttpRequest && "withCredentials" in new O.XMLHttpRequest() && J(40);
    } catch (c) {}
    a.set(ld, Td(a), !0);
    a.set(Ac, R(a, Ac) + 1);
    var b = [];
  ...
  function Bc(a) {
    ...
    (a = af(a))
      ? (J(44), (a = "&_gac=1." + K([pa(a.qa, 0), a.timestamp, a.qa].join("."))))
      : (a = "");
    return b + a;
  }
  function Ic(a, b) {
  ...
  var p = /^(GTM|OPT)-[A-Z0-9]+$/,
    ...
    Ke = function (a, b, c, d) {
      ...
      1 === e
        ...
        : 2 === e &&
          ((g.context = "c"),
          (ca = { allow_google_signals: a.get(Ud), allow_ad_personalization_signals: a.get(xe) }));
      He(g, ca);
      return t(g);
    };
  var H = {},
  ...
  var td = function (a, b) {
      ...
      if ("cookie" == P(a, ac)) {
        ...
        a.get(je) &&
          ...
          d &&
            0 != d.length &&
            ((c = d[0]), a.data.set(fe, c.timestamp / 1e3), a.data.set(ce, c.qa)));
        a.get(je) &&
          ((c = a.get(Se)),
          (d = {}),
    ...
    pd = function (a) {
      ...
      a.get(ce) ||
        (a.data.set(Se, be("wbraid", !0)), a.data.set(Te, Math.round(new Date().getTime() / 1e3)));
  ...
  var u = function (a, b, c) {
    ...
    B = function (a) {
      ...
      return "www.google-analytics.com" == a.host && (a.port || b) == b && D(a.path, "/plugins/")
        ? !0
        : !1;
    },
    ne = function (a) {
